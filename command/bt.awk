...
function bt_filter(line)
{
	...
	if (match(line, ": bt\\]$")) {
		allow_regx="[A-Z0-9_]+: ";
		allow_regx=allow_regx "|\\[[a-f0-9]+\\] ";
		allow_regx=allow_regx "|---";
		next;
	}
	...
	if (match(line, ": bt -a\\]$")) {
		...
		allow_regx=allow_regx "|\\[[a-f0-9]+\\] ";
		allow_regx=allow_regx "|---";
		allow_regx=allow_regx "|option not supported on a live system or live dump|cannot be determined: try -t or -T options";
		next;
	}
	...
	if (match(line, ": bt -v\\]$")) {
		allow_regx="possible stack overflow: ";
		allow_regx=allow_regx "|bt: invalid kernel virtual address: 0";
		allow_regx=allow_regx "|option not supported or applicable on this architecture or kernel";
		next;
	}
	...
	if (match(line, ": bt -p\\]$")) {
		...
		allow_regx=allow_regx "|---";
		allow_regx=allow_regx "|[A-Z0-9_]+: ";
		allow_regx=allow_regx "|option not supported on a live system or live dump";
		next;
	}
	...
	if (match(line, ": foreach bt\\]$")) {
		...
		allow_regx=allow_regx "|---";
		allow_regx=allow_regx "|[A-Z0-9_]+: ";
		allow_regx=allow_regx "|cannot be determined: try -t or -T options";
		next;
	}
}